        ...
        return (
            <div style={{width: "100%", height: "100vh"}}>
                ...
                <section style={{display: "flex", flexDirection: "column", textAlign: "center", justifyContent: "center", alignItems: "center", minHeight: 600, backgroundImage: "url('http://pritchardelectric.net/files/2014/04/12Untitled-6-Recovered-Recovered-Recovered-Recovered-Recovered-Recovered-Recovered-Recovered.jpg?&a=t')", backgroundAttachment: "fixed", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center"}}>
                    <h1 style={{color:"white", fontSize: 70, margin: 0, textShadow: "3px 4px 5px black", textTransform: "uppercase"}} dangerouslySetInnerHTML={{__html: firstHeader}}></h1>
                ...
                <section style={{ width: "100%", display: "flex"}}>
                    ...
                    <div style={{...width, borderTop: `6px solid ${color.one[0]}`, position: "relative", overflow:"hidden" }} onMouseOver={() => {setColor({...color, one: ["white", 1.2, 0.7]})}} onMouseLeave={() => {setColor({...color, one: ["#1f40a3", 1, 0.5]})}}>
                        ...
                        <div style={{...width, zIndex: 50, display: "flex", justifyContent: "center", alignItems: "center", color: "white", position: "absolute", top: 0}}>
